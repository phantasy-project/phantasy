...
This section maintains a collection of **Jupyter notebooks** or **IPython
notebooks** to illustrate the most fundamental features of ``phantasy``.

Original ``.ipynb`` files could be downloaded:

* :download:`Element <notebooks/phantasy_element.ipynb>`
* :download:`Lattice <notebooks/phantasy_lattice.ipynb>`
* :download:`Lattice (Advanced) <notebooks/phantasy_lattice_pro.ipynb>`
...
Data files used in these notebooks:
...
.. toctree::
    ...
    Lattice (Advanced) <notebooks/phantasy_lattice_pro.ipynb>
