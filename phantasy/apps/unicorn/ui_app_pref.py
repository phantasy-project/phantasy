...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.srv_data_btn = QtWidgets.QPushButton(self.tab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.srv_data_btn.sizePolicy().hasHeightForWidth())
        self.srv_data_btn.setSizePolicy(sizePolicy)
        self.srv_data_btn.setObjectName("srv_data_btn")
        self.horizontalLayout_3.addWidget(self.srv_data_btn)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.srv_data_btn.setText(_translate("Dialog", "Use Default"))
