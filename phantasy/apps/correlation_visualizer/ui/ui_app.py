...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.upper_limit_lineEdit.setText("")
        ...
        self.lower_limit_lineEdit.setText("")
        ...
        self.test_btn = QtWidgets.QPushButton(self.daq_groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed,
                                           QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.test_btn.sizePolicy().hasHeightForWidth())
        self.test_btn.setSizePolicy(sizePolicy)
        self.test_btn.setAutoDefault(True)
        ...
        self.save_data_tbtn.setAutoRaise(False)
        ...
        self.auto_labels_tbtn.setAutoRaise(False)
        ...
        self.auto_title_tbtn.setAutoRaise(False)
        ...
        self.moveto_tbtn.setAutoRaise(False)
        ...
        self.set_tbtn.setAutoRaise(False)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.test_btn.setText(_translate("MainWindow", "QThread-Test"))
